...
const createGoalForm = z.object({
  title: z.string().min(1, 'Informe a atividade que você deseja praticar'),
        ...
        <div className='flex flex-col gap-6 h-full'>
          <div className='flex flex-col gap-3'>
            <div className='flex items-center justify-between'>
              ...
              <DialogClose><X className='size-5 text-zinc-400' /></DialogClose>
            </div>
            <DialogDescription>Adicione atividade que te fazem bem e que você quer continuar praticando toda semana.</DialogDescription>
          </div>
          ...
          <form onSubmit={handleSubmit(handleCreateGoal)} className='flex-1 flex flex-col justify-between'>
            <div className='flex flex-col gap-6'>
              <div className='flex flex-col gap-2'>
                ...
                <Input autoFocus id='title' placeholder='Praticar exercícios, meditar, etc...'
                {...register('title')}
                />
              ...
              <div className='flex flex-col gap-2'>
                ...
                <Controller control={control} name="desiredWeeklyFrequency" defaultValue={7} render={({ field }) => {
                  return(
